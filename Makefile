...
ACLOCAL = ${SHELL} /home/nevile/poppler-0.51.0/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/nevile/poppler-0.51.0/missing autoconf
AUTOHEADER = ${SHELL} /home/nevile/poppler-0.51.0/missing autoheader
AUTOMAKE = ${SHELL} /home/nevile/poppler-0.51.0/missing automake-1.15
AWK = gawk
CAIRO_CFLAGS = 
...
CXXFLAGS = -fPIC -Wall -Woverloaded-virtual -Wnon-virtual-dtor -Wcast-align -fno-exceptions -fno-check-new -fno-common -g -O2
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = dlltool
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/nevile/poppler-0.51.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MOCQT4 = 
MOCQT42 = 
...
NM = /bin/nm -B
NMEDIT = 
NSS3_CFLAGS = -I/usr/include/nss3 -I/usr/include/nspr4  
NSS3_LIBS = -lssl3 -lsmime3 -lnss3 -lnssutil3 -lplds4 -lplc4 -lnspr4 -lpthread -ldl  
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
...
PACKAGE_STRING = poppler 0.51.0
PACKAGE_TARNAME = poppler
PACKAGE_URL = 
PACKAGE_VERSION = 0.51.0
PATH_SEPARATOR = :
PC_REQUIRES = 
PC_REQUIRES_PRIVATE = Requires.private: poppler = 0.51.0
PDFTOCAIRO_CFLAGS = 
PDFTOCAIRO_LIBS = 
...
SHELL = /bin/sh
STRIP = strip
TESTDATADIR = /home/nevile/poppler-0.51.0/./../test
VERSION = 0.51.0
XMKMF = 
X_CFLAGS = 
X_EXTRA_LIBS = 
...
X_PRE_LIBS = 
ZLIB_LIBS = -lz
abs_builddir = /home/nevile/poppler-0.51.0
abs_srcdir = /home/nevile/poppler-0.51.0
abs_top_builddir = /home/nevile/poppler-0.51.0
abs_top_srcdir = /home/nevile/poppler-0.51.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/nevile/poppler-0.51.0/install-sh
...
EXTRA_DIST = README-XPDF poppler.pc.in poppler-uninstalled.pc.in \
	...
	cmake/modules/FindNSS3.cmake cmake/modules/FindQt4.cmake \
